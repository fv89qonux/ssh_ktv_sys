 ...
 <div id="content"> <!-- Content start -->
      <div class="inner_content">
          <div class="widgets_area">
                <div class="row-fluid">
                    <div class="span12">
                      <form  action="order_order.do" method="post">  
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                             <c:if test="${order.status==0}">
								                                              未付款     &nbsp;&nbsp;
								           <a class="label label-warning" href="${ctx}/order_cancelOrder.do?id=${order.id}">取消订单</a>
								               </c:if>
                                            ...
                                            <td>
                                            <a class="btn" href="${ctx}/order_update.do?id=${order.id}" title="修改"><i class="icon-inbox"></i></a>
                                               &nbsp;&nbsp;&nbsp;&nbsp;
                                            <a class="btn"  href="${ctx}/order_delete.do?id=${order.id}" title="删除" onclick= "if(confirm( '是否删除！ ')==false)return   false; "><i class="icon-trash"></i></a>
                                            </td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
