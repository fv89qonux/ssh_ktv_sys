 ...
 <div id="content"> <!-- Content start -->
      <div class="inner_content">
          <div class="widgets_area">
                <div class="row-fluid">
                    <div class="span12">
                      <form  action="admin_admin.do" method="post">  
                         <div  class="daohanglink"style="">
                           <span class="daohang"></span>
                           <span>首页</span><span>></span>
                           <span>系统管理</span><span>></span>
                           <span>管理员管理</span>
                           <span style="margin-left: 80px"> 管理员名：</span>
					    ...
					    <button type="submit" class="label label-warning" style="margin-left: 50px">查询</button>
					      <a href="${ctx}/admin_add.do" class="label label-warning" style="float:right; margin:8px;">添加</a> 
                         </div>
                         </form>
                                    ...
                                    <tbody>
                                     <c:forEach items="${pagers.datas}" var="admin" varStatus="l">
                                        <tr>
                                            ...
                                            <td>
                                            <a class="btn" href="${ctx}/admin_update.do?id=${admin.id}" title="修改"><i class="icon-inbox"></i></a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <a class="btn"  href="${ctx}/admin_delete.do?id=${admin.id}" title="删除" onclick= "if(confirm( '是否删除！ ')==false)return   false; "><i class="icon-trash"></i></a>
                                            </td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
