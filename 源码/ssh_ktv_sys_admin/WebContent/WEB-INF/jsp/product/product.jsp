 ...
 <div id="content"> <!-- Content start -->
      <div class="inner_content">
          <div class="widgets_area">
                <div class="row-fluid">
                    <div class="span12">
                      <form  action="product_product.do" method="post">  
                         <div  class="daohanglink"style="">
                           <span class="daohang"></span>
                           <span>首页</span><span>></span>
                           <span>商品管理</span>
                           <span style="margin-left: 80px"> 商品名称：</span>
					    <input type="text" name="name" id="name"  value="${product.name}">&nbsp;&nbsp;  
					    <button type="submit" class="label label-warning" style="margin-left: 50px">查询</button>
					      <a href="${ctx}/product_add.do" class="label label-warning" style="float:right; margin:8px;">添加</a> 
                         </div>
                         </form>
                         <!--  private int id;
    ...
    private int  isDelete; //0:不删除 1：删除 -->	
                                    ...
                                    <tbody>
                                     <c:forEach items="${pagers.datas}" var="product" varStatus="l">
                                        <tr>
                                            ...
                                            <td>${product.name}</td>
                                            <td>￥${product.price}</td>
                                            <td><img src="/ssh_ktv_sys/${product.image}" style="height: 100px;width: 100px"></td>
                                            ...
                                            <td>
                                            <a class="btn" href="${ctx}/product_update.do?id=${product.id}" title="修改"><i class="icon-inbox"></i></a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <a class="btn"  href="${ctx}/product_delete.do?id=${product.id}" title="删除" onclick= "if(confirm( '是否删除！ ')==false)return   false; "><i class="icon-trash"></i></a>
                                            </td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
      ...
      <pg:pager  url="${ctx}/product_product.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
