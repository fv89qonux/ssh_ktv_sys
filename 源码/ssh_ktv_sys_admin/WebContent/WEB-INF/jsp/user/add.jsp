                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <div class="well brown">
                         <form action="user_exAdd.do"  method="post">
                            <div class="form_list"><label class="lable_title">登录账号</label>
                            <input class="form_input" name="loginName" type="text"/></div>
                            <div class="form_list"><label class="lable_title">用户姓名</label>
                            <input class="form_input" name="userName" type="text"/></div>
                            ...
                            <input class="form_input" type="text" name="address"/></div>
