                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <div class="well brown">
                         <form action="categorySec_exUpdate.do"  method="post">
                              <div class="form_list"><label class="lable_title">一级分类名称</label>
                            <input class="form_input" name="scname" type="text" value="${categorySec.scname}"/></div>
                                <input class="form_input" name="id" type="hidden" value="${categorySec.id }"/>
                             <div class="form_list"><label class="lable_title">一级分类</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <select name="category.id" >
                              <c:forEach  items="${categoryList}" var="cl" varStatus="l">
                              <c:choose>
                              <c:when test="${categorySec.category.id== cl.id}">
