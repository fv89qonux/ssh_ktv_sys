                ...
                <div class="row-fluid">
                    <div class="span12">
                         <div  class="daohanglink"style="">
                           ...
                           <span>一级分类管理</span><span>></span>
                           <span>修改一级分类</span>
                         </div>
                        <div class="well brown">
                         <form action="category_exUpdate.do"  method="post">
                              <div class="form_list"><label class="lable_title">一级分类名称</label>
                            <input class="form_input" name="cname" type="text" value="${category.cname}"/></div>
                                <input class="form_input" name="id" type="hidden" value="${category.id }"/>
